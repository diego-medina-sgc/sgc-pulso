...
CADA CAMADA ESCRIBE DISTINTO
    ...
    Persona AP.jpg                     APELLIDO, Nombre
    ALVAREZ DE OLIVERA Persona AB.jpg      igual, sin espacio
    Persona AQ.jpg                     nombre.apellido
    Persona AR 329.JPG               con el numero de la toma
    Agosti JazminENB_1015 - copia.JPG        con el codigo de camara pegado
    Persona AS Uniform ES 6 Lockwood.JPG  con el uniforme y la casa
...
# colgada: "Persona AT Y1" quedaba "Persona AT Y". Aparte
...
#
# Lo vio Diego en la lista de candidatos del juego: "Persona AU Kim",
# "Persona AV Guest", "Persona AW Skrypnyk". Son veintidos chicos de
...
# escribe "Persona AX" o "Persona AW", nunca detras de un punto. La
...
def nombre_de(archivo, contexto=""):
    ...
    Lo explico Diego mirando un archivo que yo habia leido mal:
        ...
        Persona AY. Jackson - EP 1      Apellido, Nombre. Casa - Grado
        Persona AT Y1                Nombre Apellido Grado
        Persona AP                      APELLIDO, Nombre
        Persona AQ                      nombre.apellido

    El archivo esta bien escrito; el que no entendia era este lector. De
    "Persona AY. Jackson - EP 1" sacaba "Persona AW Skrypnyk" y
    ...
    # "Persona AZ. Jpg.jpg". Se saca hasta que no quede ninguna.
    for _ in range(3):
    ...
    # "Copy of 002 Persona BA": lo que puso el que duplico la
    ...
    # guion: "Persona BB - Teaching Assistant", "Persona Z2
    ...
    if CAMARA.match(base.strip()):
        return None
    # "Persona AQ" -> "Persona AQ". Solo cuando los puntos separan
...
# convierte en "Persona BC@stgeorges edu ar" y ahi ya no sirve para nada.
...
def indexar_padron(cli):
    ...
    # "nina.dipietro" da "nina dipietro" y el padron dice "Persona BD":
    ...
    # Valeria" contra "Persona BE" del padron. No coincide
...
def confiable(pal, txt):
    ...
    ("Persona Z3", "Persona AW Skrypnyk"), y aparecieron
    ...
    # si: "Persona BF", "Persona BG", "Persona BH".
    ...
    #
    # En el medio es una inicial y es parte del nombre: "Persona BI",
    # "Persona BJ". Al final es lo que deja un grado a medio sacar
    # -"Buktenica Y"- o un apellido escrito en inicial -"Persona BK"-, y en los
    # dos casos no alcanza para crear una ficha.
    # Solo la ULTIMA. Una inicial adelante es corriente en castellano -"M
    # Persona BL", "M Persona BM", "Persona BN"- y una al
    ...
    # "acuarela Y lapiz sobre papel Martina Machia", ". Persona BO Fatch.
    # Obra de titeres El tesoro pirata".
    #
    # El largo se puede usar de corte porque el padron dice donde esta el
    # techo: de 6.128 fichas, la mas larga tiene seis palabras -"Persona BP
