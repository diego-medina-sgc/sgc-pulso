...
CADA CAMADA ESCRIBE DISTINTO
    ...
    Persona AQ.jpg                     APELLIDO, Nombre
    ALVAREZ DE OLIVERA Persona AC.jpg      igual, sin espacio
    Persona AR.jpg                     nombre.apellido
    Persona AS 329.JPG               con el numero de la toma
    Agosti JazminENB_1015 - copia.JPG        con el codigo de camara pegado
    Persona AT Uniform ES 6 Lockwood.JPG  con el uniforme y la casa
...
# colgada: "Persona AU Y1" quedaba "Persona AU Y". Aparte
...
#
# Lo vio Diego en la lista de candidatos del juego: "Persona AV Kim",
# "Persona AW Guest", "Persona AX Skrypnyk". Son veintidos chicos de
...
# escribe "Persona AY" o "Persona AX", nunca detras de un punto. La
...
def nombre_de(archivo, contexto=""):
    ...
    Lo explico Diego mirando un archivo que yo habia leido mal:
        ...
        Persona AZ. Jackson - EP 1      Apellido, Nombre. Casa - Grado
        Persona AU Y1                Nombre Apellido Grado
        Persona AQ                      APELLIDO, Nombre
        Persona AR                      nombre.apellido

    El archivo esta bien escrito; el que no entendia era este lector. De
    "Persona AZ. Jackson - EP 1" sacaba "Persona AX Skrypnyk" y
    ...
    # "Persona BA. Jpg.jpg". Se saca hasta que no quede ninguna.
    for _ in range(3):
    ...
    # "Copy of 002 Persona BB": lo que puso el que duplico la
    ...
    # guion: "Persona BC - Teaching Assistant", "Persona Z2
    ...
    if CAMARA.match(base.strip()):
        return None
    # "Persona AR" -> "Persona AR". Solo cuando los puntos separan
...
# convierte en "Persona BD@stgeorges edu ar" y ahi ya no sirve para nada.
...
def indexar_padron(cli):
    ...
    # "nina.dipietro" da "nina dipietro" y el padron dice "Persona BE":
    ...
    # Valeria" contra "Persona BF" del padron. No coincide
...
def confiable(pal, txt):
    ...
    ("Persona Z3", "Persona AX Skrypnyk"), y aparecieron
    ...
    # si: "Persona BG", "Persona BH", "Persona BI".
    ...
    #
    # En el medio es una inicial y es parte del nombre: "Persona BJ",
    # "Persona BK". Al final es lo que deja un grado a medio sacar
    # -"Buktenica Y"- o un apellido escrito en inicial -"Persona BL"-, y en los
    # dos casos no alcanza para crear una ficha.
    # Solo la ULTIMA. Una inicial adelante es corriente en castellano -"M
    # Persona BM", "M Persona BN", "Persona BO"- y una al
    ...
    # "acuarela Y lapiz sobre papel Martina Machia", ". Persona BP Fatch.
    # Obra de titeres El tesoro pirata".
    #
    # El largo se puede usar de corte porque el padron dice donde esta el
    # techo: de 6.128 fichas, la mas larga tiene seis palabras -"Persona BQ
