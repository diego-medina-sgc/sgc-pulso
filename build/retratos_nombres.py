...
uno por uno, cuando la respuesta estaba en el nombre del archivo.
    ...
    MDF_4445.jpg Persona AD.jpg          467 fotos de 2023
    ALVAREZ DE OLIVERA Persona AE.jpg     73 fotos de 2024
    Persona AF Sebastian.jpg              70 fotos de 2023
    Persona AG.jpg                  66 fotos de 2025
    Persona AH.jpg                   54 fotos de 2026
...
"Persona AD" puede ser Persona AI o Persona AD. En vez de decidirlo con
...
def por_subconjunto(pal, por_token, juegos):
    ...
    El archivo dice "Persona AK" y el padron "Persona AK
    Rossi", o al reves. Se pide que uno contenga al otro y que compartan al
    menos dos palabras: con una sola, "Persona AL" entraria en cualquier Juan.

    No se mira el orden, que es justo lo que no se sabe: "Persona AD" y
    "Persona AI" son el mismo juego de palabras.
    """
    s = frozenset(pal)
    if len(s) < 2:
        return []
...
def anotar_nombres(cli, nuevos, fol):
    ...
    Tiene razon y es la direccion correcta del flujo. "Persona AN.jpg" sirve
    para encontrar a "Persona AN - Quilmes - 2004" en el padron. Si ese Diego
    ...
    "Nini Supermercado" y "Persona X" desde el otro cargador.
...
def main():
    ...
    # llama "Persona AO.JPG": "por lo menos tendrian que venir ya
    ...
    for f in pend:
        ...
        # Cualquier orden: el juego de palabras no distingue "Persona AD"
        # de "Persona AI", que es justo lo que no hace falta decidir.
        ...
        if not cand:
            ...
            # e hijos: hay un Persona AP que se fue en 2003 y otro que
            ...
            # Y algunos son dudosos de verdad: "Persona AQ Arminio"
