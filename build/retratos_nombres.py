...
uno por uno, cuando la respuesta estaba en el nombre del archivo.
    ...
    MDF_4445.jpg Persona AA.jpg          467 fotos de 2023
    ALVAREZ DE OLIVERA Persona AB.jpg     73 fotos de 2024
    Persona AC Sebastian.jpg              70 fotos de 2023
    Persona AD.jpg                  66 fotos de 2025
    Persona AE.jpg                   54 fotos de 2026
...
"Persona AA" puede ser Persona AF o Persona AA. En vez de decidirlo con
...
def por_subconjunto(pal, por_token, juegos):
    ...
    El archivo dice "Persona AH" y el padron "Persona AH
    Rossi", o al reves. Se pide que uno contenga al otro y que compartan al
    menos dos palabras: con una sola, "Persona AI" entraria en cualquier Juan.

    No se mira el orden, que es justo lo que no se sabe: "Persona AA" y
    "Persona AF" son el mismo juego de palabras.
    """
    s = frozenset(pal)
    if len(s) < 2:
        return []
...
def anotar_nombres(cli, nuevos, fol):
    ...
    Tiene razon y es la direccion correcta del flujo. "Persona AK.jpg" sirve
    para encontrar a "Persona AK - Quilmes - 2004" en el padron. Si ese Diego
    ...
    "Nini Supermercado" y "Persona V" desde el otro cargador.
...
def main():
    ...
    # llama "Persona AL.JPG": "por lo menos tendrian que venir ya
    ...
    for f in pend:
        ...
        # Cualquier orden: el juego de palabras no distingue "Persona AA"
        # de "Persona AF", que es justo lo que no hace falta decidir.
        ...
        if not cand:
            ...
            # e hijos: hay un Persona AM que se fue en 2003 y otro que
            ...
            # Y algunos son dudosos de verdad: "Persona AN Arminio"
