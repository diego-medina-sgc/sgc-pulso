...
uno por uno, cuando la respuesta estaba en el nombre del archivo.
    ...
    MDF_4445.jpg Persona AK.jpg          467 fotos de 2023
    ALVAREZ DE OLIVERA Persona AL.jpg     73 fotos de 2024
    Persona AM Sebastian.jpg              70 fotos de 2023
    Persona AN.jpg                  66 fotos de 2025
    Persona AO.jpg                   54 fotos de 2026
...
"Persona AK" puede ser Persona AP o Persona AK. En vez de decidirlo con
...
def por_subconjunto(pal, por_token, juegos):
    ...
    El archivo dice "Persona AR" y el padron "Persona AR
    Rossi", o al reves. Se pide que uno contenga al otro y que compartan al
    menos dos palabras: con una sola, "Persona AS" entraria en cualquier Juan.

    No se mira el orden, que es justo lo que no se sabe: "Persona AK" y
    "Persona AP" son el mismo juego de palabras.
    """
    s = frozenset(pal)
    if len(s) < 2:
        return []
...
def anotar_nombres(cli, nuevos, fol):
    ...
    Tiene razon y es la direccion correcta del flujo. "Persona AU.jpg" sirve
    para encontrar a "Persona AU - Quilmes - 2004" en el padron. Si ese Diego
...
def main():
    ...
    # llama "Persona AV.JPG": "por lo menos tendrian que venir ya
    ...
    for f in pend:
        ...
        # Cualquier orden: el juego de palabras no distingue "Persona AK"
        # de "Persona AP", que es justo lo que no hace falta decidir.
        ...
        if not cand:
            ...
            # e hijos: hay un Persona AW que se fue en 2003 y otro que
            ...
            # Y algunos son dudosos de verdad: "Persona AX Arminio"
